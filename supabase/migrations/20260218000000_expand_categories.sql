-- Update and expand categories to support both Business and Private use
-- We rename the table concept to "Expenditure Categories" but keep the table name for compatibility.

-- Upsert comprehensive category list
...
-- Comment to reflect the broader usage
